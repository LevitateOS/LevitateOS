...
## Progress
- [ ] Research coreutils specifications
- [ ] Create implementation plan
- [ ] Implement required kernel syscalls (`getdents`, `unlink`, `mkdir`, `rmdir`, `rename`, etc.)
- [ ] Update `libsyscall` and `ulib`
- [ ] Create `coreutils` crate
- [ ] Implement tools in `coreutils`
- [ ] Update shell to support command execution with arguments
- [ ] Verify tools in VM

## Notes
- Using a multicall binary approach for `coreutils` as hinted by the "Busybox" name.
